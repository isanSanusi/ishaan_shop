...
document.addEventListener("DOMContentLoaded", () => {
   ...
   if (logoutBtn) {
      logoutBtn.addEventListener("click", () => {
         localStorage.removeItem("loggedInUser"); // Hapus data user yang login
...
// back button
let back = document.getElementById("backBtnDp2");
let back2 = document.getElementById("backBtnWd2");
let isiUlang = document.getElementById("isiSaldo2");
let wd = document.getElementById("withdraw2");

let main = document.getElementById("menu");
let subMenu = document.getElementById("subMenu3");
let subMenu2 = document.getElementById("subMenu4");
